    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Hello! Explore the features available to you.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigateToPage("/profile")}>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">Update your personal information, skills, and bio.</p>
            </CardContent>
          </Card>

          <Card
            className="hover:shadow-lg transition-shadow cursor-pointer"
            onClick={() => navigateToPage("/project-ideas")}
          >
            <CardHeader>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">Discover project ideas and find groups to collaborate with.</p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigateToPage("/groups")}>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">Connect with other students and work on projects together.</p>
            </CardContent>
          </Card>

          <Card
            className="hover:shadow-lg transition-shadow cursor-pointer"
            onClick={() => navigateToPage("/career-path")}
          >
            <CardHeader>
              <CardTitle className="text-xl text-teal-600">Career Path</CardTitle>
              <CardDescription>Plan your CS career journey</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigateToPage("/news")}>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">Get the latest news and updates in computer science.</p>
            </CardContent>
          </Card>
